...
-- showAggregateStatistics shows the per match statistics for a given player within a given timeframe 
...
CALL showAggregateStatistics('Rafael Nadal', '20180101', '20220101');
